# Upload an app from the local repository into a remote repository (vorteil repositories push)
...
```
vorteil repositories push REPOSITORY BUCKET/APP[/REF] PUSHABLE [flags]
```
