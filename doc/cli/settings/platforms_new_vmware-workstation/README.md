# Add a new platform using VMware Workstation (vorteil settings platforms new vmware-workstation)

Add a new platform using VMware Workstation

# Usage

```
vorteil settings platforms new vmware-workstation NAME [flags]
```
...
```
  ...
  -h, --help            help for vmware-workstation
```
