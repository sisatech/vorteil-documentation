# Unpack a Vorteil package (vorteil packages unpack)

Unpack the contents of a Vorteil package into a directory. To simplify
...
```
vorteil packages unpack PACKAGE [DEST]
```
